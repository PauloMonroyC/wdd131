...
const temples = [
...

    {
        ...
        location: "District of Cayma, Arequipa, Perú",
...
document.querySelector("#large").addEventListener("click", () => {
    const largeTenmples = temples.filter(temple => temple.area > 90000);

    createTempleCard(largeTenmples);
});
